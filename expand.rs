...
unsafe impl wasmtime::component::Lift for Response {
    ...
    fn lift(
        ...
        Ok(Self {
            content: <String as wasmtime::component::Lift>::lift(store, options, &src.content)?,
        })
    }
    #[inline]
    fn load(
        ...
        let mut offset = 0;
        Ok(Self {
            content: <String as wasmtime::component::Lift>::load(
                memory,
...
const _: () = {
    ...
    unsafe impl wasmtime::component::ComponentType for Response {
        type Lower = LowerResponse<<String as wasmtime::component::ComponentType>::Lower>;
